...
class AudioClassificationHelper {
  ...
  // Future<Map<String, double>> inference(Float32List input) async {
  //   final output = List.filled(30, List.filled(10, 0.0));  // Adjusted output shape to match model
  //   _interpreter.run(List.of(input), output);

  //   // Print the output to debug
  //   print("Model output:");
  //   for (var i = 0; i < output.length; i++) {
  //     print("Group $i: ${output[i]}");
  //   }

  //   var classification = <String, double>{};
    
  //   // Loop over all 15 groups of output
  //   for (var i = 0; i < output[0].length; i++) {
  //     double sum = 0.0;
      
  //     // Sum the values for this category (across all 15 groups)
  //     for (var j = 0; j < output.length; j++) {
  //       sum += output[j][i];
  //     }

  //     // Calculate the average
  //     classification[_labels[i]] = sum / output.length;
  //   }
